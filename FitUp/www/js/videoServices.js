...
(function () {
  ...
  // /** @ngInject */
  // function VideoService($resource) {
  //   return $resource('http://10.80.54.229:8080/video', {}, {
  //     method: 'POST'
  //   })
  // }
  //
  // /** @ngInject */
  // function videoService($resource) {
  //   return $resource('http://10.80.54.229:8080/video/:id', {id: '@_id'}, {
  //     update: {
  //       method: 'PUT', // this method issues a PUT request
  //       params: {
  //         id: '@id',
  ...
  // /** @ngInject */
  // function queryVideoService($resource) {
  //   return $resource('http://10.80.54.229:8080/videoName',
  //     {
  //       query: {
  //         method: 'GET', // this method issues a GET request
  //         params: {
  ...
  // /** @ngInject */
  // function addToFavoriteService($resource) {
  //   return $resource('http://10.80.54.229:8080/addToFavorite', {}, {
  //     // authenticate: {
  //     method: 'POST'
  //     // params: {'action': 'authenticate'},
  //     // header: {'Content-Type': 'application/x-www-form-urlencoded'}
  ...
  // /** @ngInject */
  // function getToFavoriteService($resource) {
  //   return $resource('http://10.80.54.229:8080/getToFavorite',
  //     {
  //       query: {
  //         method: 'GET' // this method issues a GET request
  //         // params: {
  ...
  // /** @ngInject */
  // function getToFavoriteIdService($resource) {
  //   return $resource('http://10.80.54.229:8080/getToFavoriteIdService/:id', {id: '@_id'}, {
  //     update: {
  //       method: 'PUT', // this method issues a PUT request
  //       params: {
  //         id: '@id'
