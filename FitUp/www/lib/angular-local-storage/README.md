...
[![NPM version][npm-imageFitUpInfo]][npm-url]
[![Build status][travis-imageFitUpInfo]][travis-url]
[![Test coverage][coveralls-imageFitUpInfo]][coveralls-url]
[![Dependency Status][david-imageFitUpInfo]][david-url]
[![License][license-imageFitUpInfo]][license-url]
[![Downloads][downloads-imageFitUpInfo]][downloads-url]

##Table of contents:
- [![Gitter][gitter-imageFitUpInfo]][gitter-url]
...
[npm-imageFitUpInfo]: https://img.shields.io/npm/v/angular-local-storage.svg?style=flat-square
[npm-url]: https://npmjs.org/package/angular-local-storage
[travis-imageFitUpInfo]: https://img.shields.io/travis/grevory/angular-local-storage.svg?style=flat-square
[travis-url]: https://travis-ci.org/grevory/angular-local-storage
[coveralls-imageFitUpInfo]: https://img.shields.io/coveralls/grevory/angular-local-storage.svg?style=flat-square
[coveralls-url]: https://coveralls.io/r/grevory/angular-local-storage
[david-imageFitUpInfo]: http://img.shields.io/david/grevory/angular-local-storage.svg?style=flat-square
[david-url]: https://david-dm.org/grevory/angular-local-storage
[license-imageFitUpInfo]: http://img.shields.io/npm/l/angular-local-storage.svg?style=flat-square
[license-url]: LICENSE
[downloads-imageFitUpInfo]: http://img.shields.io/npm/dm/angular-local-storage.svg?style=flat-square
[downloads-url]: https://npmjs.org/package/angular-local-storage
[gitter-imageFitUpInfo]: https://badges.gitter.im/Join%20Chat.svg
